...
//Sports API
router.get("/getTeamList/:name", function(req, res, next) {
  sports.NBA.getActivePlayersTeam(req.params.name, function (err, obj) {
        if (err) {
...
router.post('/sendTeam', function(req,res){
    // console.log("------------" + req.user.username);
    obj = {teamName:req.body.teamName,sessionName:req.user.username}
    return(db.addObject(obj,res));
});

router.get('/getTeams',function(req,res){
  return(db.getAllObjects(req.user.username,res));
});
/////////////////
